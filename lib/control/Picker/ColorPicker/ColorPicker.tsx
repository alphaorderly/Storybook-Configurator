...
type ColorPickerControlProps = CommonControlProps & {
  value: string;
  setValue: React.Dispatch<React.SetStateAction<string>>;
};

const ColorPickerControl = forwardRef<HTMLInputElement, ColorPickerControlProps>(
                ...
                <div className="space-y-4">
                  ...
                  <div
                    ...
                    onClick={(e) => {
                      ...
                      const rgb = hsb2rgb(extractHue(parsedValue), saturation, brightness);
